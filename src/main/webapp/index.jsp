...
<body data-theme="${appearance}" class="bg-background-light font-display text-slate-900 overflow-x-hidden">
    <div class="snap-y-container relative">
        ...
        <section class="snap-section relative px-6 overflow-hidden min-h-screen flex items-center justify-center">
            ...
            <div class="mx-auto max-w-4xl text-center relative z-10">
                <span class="inline-block px-4 py-1.5 rounded-full bg-primary/5 text-primary text-xs font-black uppercase tracking-widest mb-6">${i18n['index.badge']}</span>
                <h1 class="text-6xl md:text-8xl font-black text-slate-900 leading-[0.9] mb-8">
                    ${i18n['index.heroLine1']} <br/><span class="text-accent">${i18n['index.heroLine2']}</span>
                </h1>
